...
while True:
    ...
    if counter != 0:
        ...
        classes_held = 30
        attendance_percentage = (studentInfo['total_attendance'] / classes_held) * 100

        if attendance_percentage >= 75:
            studentInfo['standing'] = "Not Detained"
        else:
            studentInfo['standing'] = "Detained"
    
        print(studentInfo['standing'])
        ...
        if modeType != 3:
            ...
            if counter <= 10:
                ...
                cv2.putText(imgBackground, str(studentInfo['starting_year']), (1125, 625),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
                cv2.putText(imgBackground, str('View Report'), (856, 26),
                                cv2.FONT_HERSHEY_COMPLEX, 0.6, (100, 100, 100), 1)
